...
<div class="col-sm-6 col-lg-3">
	<div class="card text-white bg-flat-color-2">
		<div class="card-body pb-0">
			...
			<p class="text-light">Giáo Viên</p>
...
<div class="col-sm-6 col-lg-3">
	<div class="card text-white bg-flat-color-3">
		<div class="card-body pb-0">
			...
			<h4 class="mb-0">
				<span class="count">5110</span>
			</h4>
			<p class="text-light">Tài Khoản Clien</p>
...
<div class="col-sm-6 col-lg-3">
	<div class="card text-white bg-flat-color-4">
		<div class="card-body pb-0">
			...
			<p class="text-light">Tài Khoản Admin</p>
					...
					<div class="btn-toolbar float-right" role="toolbar"
						...
						<div class="btn-group mr-3" data-toggle="buttons" aria-label="First group">
							<label class="btn btn-outline-secondary">
								<input type="radio" name="options" id="option1" onclick="updateData('day')"> Ngày
							  </label>
							  <label class="btn btn-outline-secondary active">
								<input type="radio" name="options" id="option2" onclick="updateData('month')" checked=""> Tháng
							  </label>
							  <label class="btn btn-outline-secondary">
								<input type="radio" name="options" id="option3" onclick="updateData('year')"> Năm
							  </label>
						</div>
					</div>
				</div>
		...
		<div class="card-footer">
			<ul id="dataList">
				<li>
					...
					<strong>10.703 Người dùng (40%)</strong>
				...
				<li>
					...
					<strong>9.706 Lượt xem (60%)</strong>
					<div class="progress progress-xs mt-2" style="height: 5px;">
				...
				<li class="hidden-sm-down">
					<div class="text-muted">Những người dùng mới</div>
					<strong>8.123 Người dùng (80%)</strong>
					<div class="progress progress-xs mt-2" style="height: 5px;">
...
<div class="col-xl-3 col-lg-6">
	<section class="card">
			...
			<div class="media">
				<a href="#">
					<img class="align-self-center rounded-circle mr-3" style="width:85px; height:85px;"
						alt="" src="<?= APP_URL?>public/assets/images/admin.jpg">
				</a>
				<div class="media-body">
					<h2 class="text-white display-6">Cương</h2>
		...
		<div class="twt-write col-sm-12">
			<textarea placeholder="Write your Facebook, Enter" rows="1"
			...
			<div class="stat-widget-four">
				...
				<div class="stat-content">
					<div class="text-left dib">
						...
						<div class="stat-text">Tổng cộng: 5500</div>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="stat-widget-four">
				...
				<div class="stat-content">
					<div class="text-left dib">
						...
						<div class="stat-text">Tổng cộng: 5110</div>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="card">
		<div class="card-body">
			<div class="stat-widget-four">
				...
				<div class="stat-content">
					<div class="text-left dib">
						<div class="stat-heading"> Băng Thông</div>
						<div class="stat-text">Tổng cộng: 4TB</div>
					</div>
				</div>
			</div>
		</div>
