    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><img src="<?= APP_URL?>public/assets/images/logo.png" alt="Logo"></a>
                <a class="navbar-brand hidden" href="./"><img src="<?= APP_URL?>public/assets/images/logo2.png" alt="Logo"></a>
            </div>

            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="<?=APP_URL?>"> <i class="menu-icon fa fa-dashboard"></i>BẢNG ĐIỀU KHIỂN </a>
                    </li>
                    <h3 class="menu-title">bảng điều khiển</h3><!-- /.menu-title -->
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false"> <i class="menu-icon fa fa-table"></i>Sinh Viên</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="<?=APP_URL?>?url=StudentController/studentAdd">Thêm</a></li>
                            <li><i class="fa fa-table"></i><a href="<?=APP_URL?>?url=StudentController/studentUpdate">Cập nhật</a></li>
                            <li><i class="fa fa-table"></i><a href="<?=APP_URL?>?url=StudentController/studentList">Danh sách</a></li>
                            <li><i class="fa fa-table"></i><a href="<?=APP_URL?>?url=StudentController/studentHistoryDelete">Lịch sử xóa</a></li>
                        </ul>
                    </li>
                    <!-- <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-fort-awesome"></i><a href="<?=APP_URL?>?url=UserController/userUpdate">Cập nhật</a></li>
                            <li><i class="menu-icon ti-themify-logo"></i><a href="<?=APP_URL?>?url=UserController/userList">Danh sách</a></li>
                        </ul>
                    </li>
                    <!-- <li>
                        <a href="widgets.html"> <i class="menu-icon ti-email"></i>Tài Khoản</a>
                    </li> -->
                    <!-- <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                    ...
                    <h3 class="menu-title">Bổ sung</h3><!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
